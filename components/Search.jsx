...
const Search = ({setView, setGlobalPlaylistId, setGlobalCurrentSongId, setGlobalIsTrackPlaying, setGlobalArtistId}) => {
  ...
  const inputRef = useRef(null) //this is so when user clicks on search tap the input is already highlighted
  ...
  return (
    <div className='flex-grow h-screen text-white'>
        ...
        <div>
          {searchData === null || !inputValue.trim() ? <FeaturedPlaylists 
          //app will go a featured playlist when selected
          setView={setView}
